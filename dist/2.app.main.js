...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__ = __webpack_require__(254);
...
/* harmony export (binding) */ __webpack_require__.d(exports, "LazyFeatureModuleNgFactory", function() { return LazyFeatureModuleNgFactory; });
/* harmony export (binding) */ __webpack_require__.d(exports, "Wrapper_LazyFeatureComponent", function() { return Wrapper_LazyFeatureComponent; });
/* harmony export (binding) */ __webpack_require__.d(exports, "LazyFeatureComponentNgFactory", function() { return LazyFeatureComponentNgFactory; });
/* harmony export (binding) */ __webpack_require__.d(exports, "View_LazyFeatureComponent0", function() { return View_LazyFeatureComponent0; });
/**
...
var LazyFeatureModuleInjector = (function (_super) {
    ...
    function LazyFeatureModuleInjector(parent) {
        _super.call(this, parent, [LazyFeatureComponentNgFactory], []);
    }
    Object.defineProperty(LazyFeatureModuleInjector.prototype, "_ROUTES_9", {
        get: function () {
            if ((this.__ROUTES_9 == null)) {
                (this.__ROUTES_9 = [[
                        {
                            path: '',
                            component: __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */],
                            pathMatch: 'full'
                        },
                        {
                            path: 'feature',
    ...
    LazyFeatureModuleInjector.prototype.createInternal = function () {
        ...
        this._LazyFeatureModule_8 = new __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["b" /* LazyFeatureModule */](this._Http_7);
    ...
    LazyFeatureModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["b" /* LazyFeatureModule */])) {
            return this._LazyFeatureModule_8;
        }
...
var LazyFeatureModuleNgFactory = new __WEBPACK_IMPORTED_MODULE_0__angular_core_src_linker_ng_module_factory__["b" /* NgModuleFactory */](LazyFeatureModuleInjector, __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["b" /* LazyFeatureModule */]);
var Wrapper_LazyFeatureComponent = (function () {
    function Wrapper_LazyFeatureComponent() {
        this._changed = false;
        this.context = new __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */]();
    }
    Wrapper_LazyFeatureComponent.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_LazyFeatureComponent.prototype.ngOnDestroy = function () {
    };
    Wrapper_LazyFeatureComponent.prototype.ngDoCheck = function (view, el, throwOnChange) {
        var changed = this._changed;
        this._changed = false;
        return changed;
    };
    Wrapper_LazyFeatureComponent.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_LazyFeatureComponent.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_LazyFeatureComponent.prototype.subscribe = function (view, _eventHandler) {
        this._eventHandler = _eventHandler;
    };
    return Wrapper_LazyFeatureComponent;
}());
var nodeDebugInfos_LazyFeatureComponent_Host0 = [new __WEBPACK_IMPORTED_MODULE_12__angular_core_src_linker_debug_context__["b" /* StaticNodeDebugInfo */]([__WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */]], __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */], {})];
var renderType_LazyFeatureComponent_Host = __WEBPACK_IMPORTED_MODULE_13__angular_core_src_linker_view_utils__["createRenderComponentType"]('', 0, __WEBPACK_IMPORTED_MODULE_14__angular_core_src_metadata_view__["b" /* ViewEncapsulation */].None, [], {});
var View_LazyFeatureComponent_Host0 = (function (_super) {
    __extends(View_LazyFeatureComponent_Host0, _super);
    function View_LazyFeatureComponent_Host0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_LazyFeatureComponent_Host0, renderType_LazyFeatureComponent_Host, __WEBPACK_IMPORTED_MODULE_15__angular_core_src_linker_view_type__["a" /* ViewType */].HOST, viewUtils, parentView, parentIndex, parentElement, __WEBPACK_IMPORTED_MODULE_16__angular_core_src_change_detection_change_detection__["f" /* ChangeDetectorStatus */].CheckAlways, nodeDebugInfos_LazyFeatureComponent_Host0);
    }
    View_LazyFeatureComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = __WEBPACK_IMPORTED_MODULE_13__angular_core_src_linker_view_utils__["selectOrCreateRenderHostElement"](this.renderer, 'lazy-feature-comp', __WEBPACK_IMPORTED_MODULE_13__angular_core_src_linker_view_utils__["EMPTY_INLINE_ARRAY"], rootSelector, this.debug(0, 0, 0));
        this.compView_0 = new View_LazyFeatureComponent0(this.viewUtils, this, 0, this._el_0);
        this._LazyFeatureComponent_0_3 = new Wrapper_LazyFeatureComponent();
        this.compView_0.create(this._LazyFeatureComponent_0_3.context);
        this.init(this._el_0, (this.renderer.directRenderer ? null : [this._el_0]), null);
        return new __WEBPACK_IMPORTED_MODULE_17__angular_core_src_linker_component_factory__["b" /* ComponentRef_ */](0, this, this._el_0, this._LazyFeatureComponent_0_3.context);
    };
    View_LazyFeatureComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */]) && (0 === requestNodeIndex))) {
            return this._LazyFeatureComponent_0_3.context;
        }
        return notFoundResult;
    };
    View_LazyFeatureComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this.debug(0, 0, 0);
        this._LazyFeatureComponent_0_3.ngDoCheck(this, this._el_0, throwOnChange);
        this.compView_0.detectChanges(throwOnChange);
    };
    View_LazyFeatureComponent_Host0.prototype.destroyInternal = function () {
        this.compView_0.destroy();
    };
    View_LazyFeatureComponent_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_LazyFeatureComponent_Host0;
}(__WEBPACK_IMPORTED_MODULE_11__angular_core_src_linker_view__["b" /* DebugAppView */]));
var LazyFeatureComponentNgFactory = new __WEBPACK_IMPORTED_MODULE_17__angular_core_src_linker_component_factory__["a" /* ComponentFactory */]('lazy-feature-comp', View_LazyFeatureComponent_Host0, __WEBPACK_IMPORTED_MODULE_1__lazy_feature_module__["a" /* LazyFeatureComponent */]);
var styles_LazyFeatureComponent = [];
var nodeDebugInfos_LazyFeatureComponent0 = [new __WEBPACK_IMPORTED_MODULE_12__angular_core_src_linker_debug_context__["b" /* StaticNodeDebugInfo */]([], null, {})];
var renderType_LazyFeatureComponent = __WEBPACK_IMPORTED_MODULE_13__angular_core_src_linker_view_utils__["createRenderComponentType"]('C:/Users/ricchi/Downloads/ng2-aot/app/feature/lazy-feature.module.ts class LazyFeatureComponent - inline template', 0, __WEBPACK_IMPORTED_MODULE_14__angular_core_src_metadata_view__["b" /* ViewEncapsulation */].None, styles_LazyFeatureComponent, {});
var View_LazyFeatureComponent0 = (function (_super) {
    __extends(View_LazyFeatureComponent0, _super);
    function View_LazyFeatureComponent0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_LazyFeatureComponent0, renderType_LazyFeatureComponent, __WEBPACK_IMPORTED_MODULE_15__angular_core_src_linker_view_type__["a" /* ViewType */].COMPONENT, viewUtils, parentView, parentIndex, parentElement, __WEBPACK_IMPORTED_MODULE_16__angular_core_src_change_detection_change_detection__["f" /* ChangeDetectorStatus */].CheckAlways, nodeDebugInfos_LazyFeatureComponent0);
    }
    View_LazyFeatureComponent0.prototype.createInternal = function (rootSelector) {
        var parentRenderNode = this.renderer.createViewRoot(this.parentElement);
        this._text_0 = this.renderer.createText(parentRenderNode, 'lazy feature!', this.debug(0, 0, 0));
        this.init(null, (this.renderer.directRenderer ? null : [this._text_0]), null);
        return null;
    };
    return View_LazyFeatureComponent0;
}(__WEBPACK_IMPORTED_MODULE_11__angular_core_src_linker_view__["b" /* DebugAppView */]));
//# sourceMappingURL=C:/Users/ricchi/Downloads/ng2-aot/app/feature/lazy-feature.module.ngfactory.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return LazyFeatureComponent; });
/* harmony export (binding) */ __webpack_require__.d(exports, "b", function() { return LazyFeatureModule; });
...
//# sourceMappingURL=C:/Users/ricchi/Downloads/ng2-aot/app/feature/lazy-feature.module.js.map
